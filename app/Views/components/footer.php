<footer class="bg-slate-900 text-slate-400 mt-20 pt-16 rounded-t-[40px] relative overflow-hidden shadow-2xl">
    ...
    <div class="absolute top-0 left-1/4 w-64 h-64 bg-blue-500/5 rounded-full blur-[80px]"></div>
    <div class="absolute bottom-0 right-1/4 w-96 h-96 bg-indigo-500/5 rounded-full blur-[100px]"></div>
    ...
    <div class="container mx-auto px-8 lg:px-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-slate-800">
            ...
            <div class="lg:col-span-1">
                ...
                <p class="text-slate-400 text-sm leading-relaxed mb-6">
                    Platform manajemen dan analisis data investasi terintegrasi milik DPMPTSP Kabupaten Tanah Bumbu. Membangun masa depan ekonomi yang transparan.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li>
                        <a href="<?= base_url('dashboard') ?>" class="hover:text-blue-400 transition-colors flex items-center group text-sm">
                            <i class="fas fa-chevron-right text-[10px] mr-2 text-slate-600 group-hover:text-blue-400 transition-colors"></i>
                            Dashboard Realisasi
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('faq') ?>" class="hover:text-blue-400 transition-colors flex items-center group text-sm">
                            <i class="fas fa-chevron-right text-[10px] mr-2 text-slate-600 group-hover:text-blue-400 transition-colors"></i>
                            Pusat Jawaban (FAQ)
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('auth/login') ?>" class="hover:text-blue-400 transition-colors flex items-center group text-sm">
                            <i class="fas fa-chevron-right text-[10px] mr-2 text-slate-600 group-hover:text-blue-400 transition-colors"></i>
                            Login Administrator
                        </a>
                    </li>
            ...
            <div>
                ...
                <div class="space-y-5">
                    <div class="flex items-start">
                        <div class="w-8 h-8 bg-slate-800 rounded-lg flex items-center justify-center mr-3 mt-1 text-amber-500 shadow-inner">
                    ...
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-slate-800 rounded-lg flex items-center justify-center mr-3 text-blue-500 shadow-inner">
        ...
        <div class="py-10 flex flex-col md:flex-row justify-between items-center gap-6">
            <div class="text-[13px] text-slate-500">
                &copy; <?= date('Y') ?> <span class="text-white font-bold">DataInvest</span>. Dinas Penanaman Modal dan Pelayanan Terpadu Satu Pintu | Tanah Bumbu
            </div>
            <div class="text-[13px] text-slate-500 flex items-center">
                Made with <i class="fas fa-heart text-rose-500 mx-2 animate-pulse"></i> by 
                <a href="https://github.com/gilangrizkyr" target="_blank" class="text-blue-400 font-bold hover:underline ml-2 transition-all">GilangRizky</a>
            </div>
        </div>
    </div>
</footer>