...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('logotanbu.png?v=' . time()) ?>">
...
<body>
    <!-- Back Button -->
    <a href="<?= base_url('/') ?>"
        class="absolute top-6 left-6 z-50 flex items-center space-x-2 px-5 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-xl backdrop-blur-md border border-white/10 transition-all duration-300 group shadow-xl">
